...
*screen du mind truc comme ca ca fais stylé t'as vu  *\\
(et ca gratte une page)
\newpage 
	...
	\section{Graphismes}
		...
		\subsection {Personnage(s)}
 		Fidèle au nom du jeux : SplashBird, le personnage officiel est un oiseau (plus précisemment un houla-houla). Mais cet oiseau, tout comme les fonds pourras etre modifiés dans des versions ultérieures du jeux et ainsi se transformer en d'autres especes d'oiseaux ou même d'autres animaux.\\\vspace{5mm}
