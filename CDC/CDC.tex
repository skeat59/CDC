...
\chapter {Pr\'esentations}
	...
	\section{ L'\'equipe }
		...
		La Team Girafe est  un groupe constitué de quatres personnes : Mathilde Laplaze alias "Mattou", la seule fille du groupe, Florent Youinou alias "T4ze", Thibault Gdalia alias "Skeat", le chef de ce projet et Vincent. Retenez bien ces pseudos car dans le reste de ce cahier des charges nous n'utiliserons plus nos 		noms et pr\'enoms. Nous sommes r\'epartie sur deux classes : la SUPB2 et la SUPD2. \\
