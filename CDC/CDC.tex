...
\\
\\
	\indent En plus de cela le joueur pourra jouer au mode en ligne. Le but est d'aller le plus loin possible sur une map sans fin. Des partie de map seront choisi aléatoirement et  mis bout à bout lorsque le joueur meurt le score est envoyé vers notre base de données, si il est supérieur au meilleur score du joueur son score est mis a jour ainsi que le classement.
\newpage 
