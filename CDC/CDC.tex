...
\chapter {Introduction}
		Pour notre année du sup, nous avons un projet libre à développer par petit groupe de 4 personnes. Nous avons donc formé notre groupe qui vous sera présenté plus loin. Nous avons décidé, pour ce premier projet, de créer un jeu vidéo (on aime l'originalité de l'idée). Créer un jeu vidéo est une opportunité qu'EPITA nous donne et on doit la saisir.\\
		Travailler en groupe est un un point important, la motivation aussi En effet, il faut être motivé pour qu'il y ai une bonne entente générale, cela affectera de même sur la réussite du projet. C'est pourquoi la question principale qui s'est posée est : êtes vous motivé.\\
		Ainsi, le long de ce cahier des charges nous allons présenté notre groupe et notre jeu. En espérant que celui-ci plaira.
